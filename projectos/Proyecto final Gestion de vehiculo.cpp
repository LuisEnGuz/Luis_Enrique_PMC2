...
void calcularCostoViaje() {
    ...
    scanf("%f", &kmViaje);
    printf("Porcentaje de km en ciudad (0-100): ");
    ...
    if (strcmp(v.tipoCombustible, "Gasolina") == 0)
        costoCombustible = (galonesCiudad + galonesCarretera) * 290; // RD$ por galón aprox
    else
        costoCombustible = (galonesCiudad + galonesCarretera) * 230; // RD$ por galón aprox
